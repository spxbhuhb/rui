...
import hu.simplexion.rui.kotlin.plugin.ir.plugin.*
import hu.simplexion.rui.kotlin.plugin.ir.plugin.RuiConfigurationKeys.ANNOTATION
import hu.simplexion.rui.kotlin.plugin.ir.plugin.RuiConfigurationKeys.DUMP
import hu.simplexion.rui.kotlin.plugin.ir.plugin.RuiConfigurationKeys.EXPORT_STATE
import hu.simplexion.rui.kotlin.plugin.ir.plugin.RuiConfigurationKeys.IMPORT_STATE
import hu.simplexion.rui.kotlin.plugin.ir.plugin.RuiConfigurationKeys.PLUGIN_LOG_DIR
import hu.simplexion.rui.kotlin.plugin.ir.plugin.RuiConfigurationKeys.PRINT_DUMPS
import hu.simplexion.rui.kotlin.plugin.ir.plugin.RuiConfigurationKeys.ROOT_NAME_STRATEGY
import hu.simplexion.rui.kotlin.plugin.ir.plugin.RuiConfigurationKeys.TRACE
