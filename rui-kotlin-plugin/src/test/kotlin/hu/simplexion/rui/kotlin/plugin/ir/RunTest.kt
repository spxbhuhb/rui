...
class RunTest {
    ...
    fun compile(fileName: String, production: Boolean, manual: Boolean = false) {
        ...
        val sourceCode = Files
            ...
            .decodeToString()
            .replace("package hu.simplexion.rui.kotlin.plugin.ir.run", "package hu.simplexion.rui.kotlin.plugin.ir.run.gen")
        ...
        with(result.classLoader.loadClass("hu.simplexion.rui.kotlin.plugin.ir.run.gen.${fileName.replace(".kt", "Kt")}")) {
